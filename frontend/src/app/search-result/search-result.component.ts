...
import { type AfterViewInit, Component, NgZone, type OnDestroy, ViewChild, ChangeDetectorRef, inject, SecurityContext } from '@angular/core'
...
export class SearchResultComponent implements OnDestroy, AfterViewInit {
  ...
  filterTable () {
    ...
    if (queryParam) {
      ...
      this.searchValue = this.sanitizer.sanitize(SecurityContext.HTML, queryParam) || queryParam
